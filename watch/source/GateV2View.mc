...
module GateV2 {
    ...
    // Run A transcode: base64 String → ByteArray. SAFE ONLY for well-formed
    // base64 — on SDK 8.4.0 convertEncodedString raises an UNCATCHABLE system
    // error on malformed input (Story 1.2 lesson). On-device payloads are
    // self-generated by the companion, so they are well-formed by
    // construction; tests must never feed this garbage.
